...
export default function Table({ users }) {
    ...
    return (
        <div className="overflow-auto rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            {users.map((user, key) => (
                <div key={key} className="grid grid-cols-4 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-4 md:px-6 2xl:px-7.5">
                    ...
                    <div className="col-span-1 flex items-center">
                        <div className="flex items-center space-x-3.5">
                            <Link href={`/user/${user.id}`} className="hover:text-primary">
                                <svg 
